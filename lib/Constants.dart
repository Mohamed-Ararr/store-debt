...
const EdgeInsets paddingAll15 = EdgeInsets.all(15);
const EdgeInsets paddingTB14RL15 =
    EdgeInsets.symmetric(horizontal: 15, vertical: 14);
BorderRadius bRadius10 = BorderRadius.circular(10);
BorderRadius bRadiusHalf = BorderRadius.circular(100);
